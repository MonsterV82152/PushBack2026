...
inline const int LEVER_UP_ANGLE = 3000;
inline const int LEVER_DOWN_ANGLE = 1800;

/* misc */
inline static bool scoring = false;
inline int intakeState = 0;
inline bool intakeOn = false;

/* Score thread control */
inline static bool scoreRequested = false;
inline static int scoreSpeed = 127;
inline static int scoreTimeout = 500;

/* Lever reset control */
inline static bool leverResetting = false;
inline static bool leverRaising = false;
