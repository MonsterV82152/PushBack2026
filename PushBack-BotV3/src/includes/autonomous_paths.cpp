...
void left()
{
    ...
    robot.moveToPoint(-70, 48, 1500, {.maxSpeed = 70, .minSpeed = 60});
...
void left2()
{
    ...
    robot.matchLoad();
    correct_position(frontDistanceSensor, &locator, false);
    robot.turnToPoint(-24, 23, 500, {false});
    robot.moveToPoint(-24, 23, 900, {false});
...
void right2()
{
    ...
    robot.moveToPoint(-10, -10, 1000, {.maxSpeed = 70});
    robot.waitUntilDone();
    ...
    robot.lowerIntake();
    robot.intake();
    robot.turnToPoint(-52, -48, 1200, {false});
    robot.moveToPoint(-52, -48, 1200, {false});
    robot.turnToPoint(-70, -48, 800);
    robot.matchLoad(true);
