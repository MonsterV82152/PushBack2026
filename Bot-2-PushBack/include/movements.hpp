...
inline const rollerState L1SKILLS = {-50, -100, -50, -50, OFF, LEAVE, ON};
inline const rollerState L1 = {-150, -150, -150, -150, OFF, LEAVE, ON};
inline const rollerState L1AUTO = {-50, -100, -50, -50, OFF, LEAVE, OFF};
